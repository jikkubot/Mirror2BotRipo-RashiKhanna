...
class GoogleDriveHelper:
    ...
    def deletefile(self, link: str):
        ...
        try:
            ...
            msg = "<b>🗑️ Successfully Deleted</b>"
        except HttpError as err:
            LOGGER.error(str(err))
            if "File not found" in str(err):
                msg = "No such file exist"
            else:
                msg = "<b>🔐 Something Went Wrong Please Check Log 😎</b>"
        finally:
            return msg
        ...
        while response is None:
            ...
            try:
                ...
                if err.resp.get('content-type', '').startswith('application/json'):
                    ...
                    if reason not in [
                        '<b>UserRateLimitExceeded</b>',
                        '<b>DailyLimitExceeded</b>',
                    ]:
                        raise err
                    if USE_SERVICE_ACCOUNTS:
        ...
        try:
            ...
            if meta.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                if self.is_cancelled:
                    ...
                    LOGGER.info(f"{msg}")
                    return "<b>♻️ Your Clone has been Stopped and Cloned Data has been 🗑️ Deleted!</b>", "<b>❌ Cancelled 🤓</b>"
                ...
                try:
                    ...
                    typ = 'File'
                try:
                    msg += f'\n\n<b>💽 Size : {get_readable_file_size(int(meta.get("size")))}</>'
                    msg += f'\n<b>📦 Type : {typ}</b>'
                except TypeError:
                    pass
                if INDEX_URL is not None:
